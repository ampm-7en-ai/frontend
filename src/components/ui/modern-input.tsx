...
const ModernInput = React.forwardRef<HTMLInputElement, ModernInputProps>(
  ({ className, type, variant = 'modern', ...props }, ref) => {
    const variants = {
      ...
      modern: "bg-white/80 dark:bg-slate-800/80 border-slate-200 dark:border-slate-600 rounded-xl focus-visible:ring-blue-500/50 dark:focus-visible:ring-blue-400/50 focus-visible:border-transparent hover:border-slate-300/80 dark:hover:border-slate-500/80",
