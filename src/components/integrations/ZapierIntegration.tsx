  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-neutral-800/70 rounded-lg border border-neutral-200 dark:border-none p-6">
        <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Webhook Configuration</h3>
        
        <form onSubmit={handleTrigger} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="webhook-url" className="font-medium text-neutral-900 dark:text-neutral-100">
              Zapier Webhook URL
            </Label>
            <ModernInput 
              id="webhook-url"
      ...
      <div className="bg-white dark:bg-neutral-800/70 rounded-lg border border-neutral-200 dark:border-none p-6">
        <div className="flex items-center gap-3 mb-4">
          <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Setup Instructions</h3>
        </div>
      ...
      {/* Features Overview */}
      <div className="bg-white dark:bg-neutral-800/70 rounded-lg border border-neutral-200 dark:border-none p-6">
        <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Zapier Capabilities</h3>
