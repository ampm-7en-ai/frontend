...
const MessageList = ({ conversation, selectedAgent }: MessageProps) => {
  ...
  const handleRevise = (message: Message) => {
  ...
  const getPreviousUserMessage = (currentMessage: Message) => {
    if (!conversation.messages) return "No previous question found";
    
    const currentMessageIndex = conversation.messages.findIndex(msg => msg.id === currentMessage.id);
  ...
  return (
    <>
            ...
            <div className={cn(
              ...
              {message.sender === 'user' ? (
                ...
                <div 
                  ...
                  onMouseEnter={() => setShowControls(message.id)}
                ...
                >
                  ...
                  <div 
                    className={cn(
                      ...
                      showControls === message.id ? "opacity-100" : "opacity-0",
      ...
      <MessageRevisionModal
        ...
        question={selectedMessage ? getPreviousUserMessage(selectedMessage) : ""}
