...
const ConversationDetailsPanel = ({ 
  ...
  if (!conversation) {
    return (
      <div className="h-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-4 flex items-center justify-center">
        <div className="text-center">
          <div className="w-10 h-10 mx-auto mb-3 rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center">
            <MessageSquare className="h-5 w-5 text-gray-400 dark:text-slate-500" />
          </div>
    ...
    <div className="h-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm overflow-y-auto">
      <div className="p-4 space-y-4">
        ...
        <section>
          ...
          <div className="bg-white/50 dark:bg-slate-700/50 rounded-xl p-4 border border-slate-200/50 dark:border-slate-600/50 backdrop-blur-sm">
          ...
          <div className="bg-white/50 dark:bg-slate-700/50 rounded-xl p-4 border border-slate-200/50 dark:border-slate-600/50 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-lg p-3 border border-slate-200/50 dark:border-slate-600/50">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{conversation.customer || "Visitor"}</p>
              </div>
              
              {conversation.email && (
                <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-lg p-3 border border-slate-200/50 dark:border-slate-600/50">
                  <h4 className="font-medium text-slate-900 dark:text-slate-100 mb-1 flex items-center gap-2 text-sm">
                    <Mail className="h-3 w-3" />
                    Email
                  </h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">{conversation.email}</p>
                </div>
              )}
          ...
          <div className="bg-white/50 dark:bg-slate-700/50 rounded-xl p-4 border border-slate-200/50 dark:border-slate-600/50 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-lg p-3 border border-slate-200/50 dark:border-slate-600/50">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">3 conversations this month</p>
              </div>
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {conversation.topic?.slice(0, 3).map((topic: string, index: number) => (
                    <Badge 
                      key={index} 
                      variant="outline" 
                      className="text-xs px-2 py-0.5 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-600"
                    >
                      {topic}
                    </Badge>
                  )) || (
              ...
              <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-lg p-3 border border-slate-200/50 dark:border-slate-600/50">
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  <Badge className="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 border-blue-200 dark:border-blue-800 text-xs px-2 py-0.5">
                    Frustrated
                  </Badge>
                  <Badge className="bg-gray-100 dark:bg-slate-800 text-gray-800 dark:text-slate-300 border-gray-200 dark:border-slate-600 text-xs px-2 py-0.5">
                    Neutral
                  </Badge>
                  <Badge className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-green-200 dark:border-green-800 text-xs px-2 py-0.5">
                    Satisfied
                  </Badge>
                </div>
              </div>
