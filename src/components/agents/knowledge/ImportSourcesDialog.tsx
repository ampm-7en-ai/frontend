...
export const ImportSourcesDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[1400px] w-[95vw] h-[95vh] max-h-[900px] p-0 overflow-hidden" fixedFooter>
        ...
        <DialogFooter className="px-6 py-4 border-t flex-shrink-0" fixed>
