  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col dotted-background">
        {/* Canvas Header */}
        <div className="p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-white/20 dark:border-gray-700/50">
        ...
        {/* Chat Input */}
        <div className="p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-t border-white/20 dark:border-gray-700/50">
          <ChatInput 
