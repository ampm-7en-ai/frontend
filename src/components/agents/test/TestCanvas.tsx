  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col dotted-background relative">
        {/* Canvas Header */}
        <div className="h-14 px-4 bg-white dark:bg-[hsla(0,0%,0%,0.95)] backdrop-blur-sm border-b border-border flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="border-t bg-white dark:bg-[hsla(0,0%,0%,0.95)] backdrop-blur-sm px-4 py-4 flex-shrink-0">
            <ChatInput 
