...
const GeneralSection: React.FC<GeneralSectionProps> = ({ agent, onAgentChange }) => {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            onChange={(e) => onAgentChange('description', e.target.value)}
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            <Switch 
              ...
              onCheckedChange={(checked) => onAgentChange('status', checked ? 'active' : 'inactive')} 
            />
