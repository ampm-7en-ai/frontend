...
import { Bot, MessageSquare, ChevronRight, Book, Users, BarChart2, PieChart, TrendingUp, ArrowUp, ArrowDown, DollarSign, Clock, Activity } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Key metrics and business health indicators</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <CardContent className="p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold mt-1">4.8m</h3>
                      <p className="text-xs text-green-600 flex items-center mt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-slate-50 rounded-lg p-4">
                <h3 className="text-sm font-medium mb-3">Top Performing Channels</h3>
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <h3 className="text-sm font-medium mb-3">Business Objectives</h3>
                <div className="space-y-3">
